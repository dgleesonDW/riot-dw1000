...
* Flash the four NRF52840 Nordic platforms with `dw1000_multithreaded_app` application as mention in README.md. 
...
![Tracking Log](./images/Tracking_multithread_log.png)
...
![Tracking_T0_Log](./images/Tracking_T0__multithread_log.png)
