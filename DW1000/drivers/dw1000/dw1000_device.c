...
#ifdef DW1000_EXAMPLES
    dwt_softreset();                  // NOTE: dwt_softreset() is required for Decawave examples
#endif
 ...
 * input parameters
 * @param gpioNum    -   this is the GPIO to configure - see GxM0... GxM8 in the dw1000_regs.h file
 * @param value  -   this sets the GPIO value - see GDP0... GDP8 in the dw1000_regs.h file
 *
 * output parameters
 *
 * no return value
