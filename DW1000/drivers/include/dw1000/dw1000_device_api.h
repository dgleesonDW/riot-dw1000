...
/*! ----------------------------------------------------------------------------
 * @file    dw1000_device_api.h
 * @brief   DW1000 API Functions
 *
 */

#ifndef _DW1000_DEVICE_API_H_
#define _DW1000_DEVICE_API_H_
 ...
 *
 * input parameters
 * @param gpioNum    -   this is the GPIO to configure - see GxM0... GxM8 in the dw1000_regs.h file
 * @param direction  -   this sets the GPIO direction - see GxP0... GxP8 in the dw1000_regs.h file
 *
 * output parameters
 *
 * no return value
 ...
 * input parameters
 * @param gpioNum    -   this is the GPIO to configure - see GxM0... GxM8 in the dw1000_regs.h file
 * @param direction  -   this sets the GPIO value - see GDP0... GDP8 in the dw1000_regs.h file
 *
 * output parameters
 *
 * no return value
