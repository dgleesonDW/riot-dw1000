...
void instance_config(instanceConfig_t *config, sfConfig_t *sfConfig)
{
    ...
    {
        SPI_ConfigFastRate(DW1000_SPI_LOW); //reduce SPI to < 3MHz
...
#ifdef  DELAYED_TX_ENABLE // Depending on the board either Delayed or Immediate transmission will be chosen
